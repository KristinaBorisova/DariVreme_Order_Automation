...
def main():
    ...
    try:
        ...
        client_details = {
            ...
            "phone": "+359888123456",  # Bulgarian phone number
            "email": "orders@darivreme.com"
        }
        ...
        order_results = process_orders_from_quotes(
            ...
            rate_limit_per_sec=1.5,  # Conservative rate for production
            log_orders=True,  # Enable order logging
            excel_output_file="production_order_results.xlsx",  # Fallback Excel file
